...
use crate::util::{f32x4_flip_signs, hi_dp, mul_ss, shuffle_wwww,shuffle_wyzx};
...
pub fn dot03(a:f32x4, b:f32x4)->(f32x4,f32x4) {
  ...
  p1_out = Mask32::from_array([true, false, false, false]).select(p1_out, f32x4::splat(0.0)); // TODO check if correct
