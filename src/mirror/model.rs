...
use crate::mirror::{camera::Camera,mesh::{Vertex, Triangle}};
...
pub struct Model {
  ...
  index_count: u32,
  // view: wgpu::TextureView, why not add view here?
  render_pipeline: wgpu::RenderPipeline,
}

impl Model {
  pub fn new(device: &wgpu::Device, format: wgpu::TextureFormat, verts: &[Vertex], tris: &[Triangle])->Self {
    ...
    //   String::from_utf8(
    //     std::fs::read("src/mirror/model.wgsl")
