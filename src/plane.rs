...
use crate::util::{f32x4_abs, flip_signs, hi_dp, hi_dp_bc};
use crate::{Branch, Dual, IdealLine, Line, Motor, Point};
use core_simd::{f32x4, mask32x4};
use std::ops::{
    Add, AddAssign, BitAnd, BitOr, BitXor, Div, DivAssign, Fn, Mul, MulAssign, Neg, Not, Sub,
    SubAssign,
};
...
impl Plane {
    ...
    pub fn project_point(self, a: Point) -> Plane {
        (self | a) | a
    }
    ...
    // possible).
    pub fn project_line(self, l: Line) -> Plane {
        (self | l) | l
    }
}
...
impl Neg for Plane {
    ...
    fn neg(self) -> Self::Output {
        Plane {
            p0: flip_signs(self.p0, mask32x4::from_array([false, true, true, true])),
        }
    }
}
