use crate::util::{
    add_ss, f32x4_xor, flip_signs, hi_dp, rcp_nr1, shuffle_dddd, shuffle_wwww, shuffle_wwyz,
    shuffle_wyzw, shuffle_wyzx, shuffle_wzwy, shuffle_wzxy, shuffle_xxyz, shuffle_xzwy,
    shuffle_ywyz, shuffle_yyzw, shuffle_yyzx, shuffle_yyzz, shuffle_yzwy, shuffle_zwyx,
    shuffle_zwyz, shuffle_zyzw, shuffle_zzwy, shuffle_zzxy,
};
...
pub fn swmm<const N: bool, const F: bool, const P: bool>(
    _a: f32x4,
    _b: f32x4,
    _c: Option<f32x4>,
) -> (f32x4, f32x4) {
...
pub fn swl2(a: f32x4, d: f32x4, c: f32x4) -> (f32x4, f32x4) {
    ...
    p2_out -= flip_signs(
        a * shuffle_wwww(c),
        mask32x4::from_array([true, false, false, false]),
    );
    (a, p2_out + p2_out + d)
}

pub fn sw312<const N: bool, const F: bool>(_a: f32x4, _b: f32x4, _c: f32x4) -> f32x4 {
    // todo count param
    todo!()
}
